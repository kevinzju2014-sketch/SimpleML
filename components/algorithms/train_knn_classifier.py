...
def train_knn_classifier(n_neighbors=5, weights='uniform', algorithm='auto',
    ...
    """
    # 构建参数字典
    # 注意：sklearn的KNeighborsClassifier也有algorithm参数，需要重命名以避免冲突
    params = {
    ...
    readme = f"""KNN分类器参数配置
==================
算法名称: K-Nearest Neighbors Classifier
适用范围: 分类任务
参数配置:
  - 邻居数: {n_neighbors}
  - 权重函数: {weights}
